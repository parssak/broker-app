...
const brokerSubCategories = [
  ...
  },
  {
    ...
    label: "Bankruptcy",
    status: "upcoming",
    tagline: "What is your bankruptcy status?",
  },
  {
    id: "environmental",
    ...
    status: "upcoming",
    tagline:
      "What is your environmental report(s), Reliance Letter(s) & Peer Review(s)?",
  },
  {
    id: "geotechnical",
    ...
    status: "upcoming",
    tagline: "What is your geotechnical report(s) & Peer Review(s)?",
  },
  {
    id: "appraisal",
    ...
    status: "upcoming",
    tagline: "What is your appraisal report(s) & Peer Review(s)?",
  },
  {
    id: "survey",
    ...
    label: "Survey",
    status: "upcoming",
    tagline: "What is your current survey for the property?",
  },
  {
    id: "insurance",
    ...
    label: "Insurance",
    status: "upcoming",
    tagline: "What is your insurance policy for the property?",
  },
  {
    id: "drawing",
    ...
    status: "upcoming",
    tagline: "What is your project drawing for the property?",
  },
  {
    id: "property-tax",
    ...
    status: "upcoming",
    tagline: "What is your property tax current (paid) for the property?",
  },
  {
    id: "title-search",
    ...
    status: "upcoming",
    tagline: "What is your title search for the property?",
  },
  {
    id: "project-budget",
    ...
    status: "upcoming",
    tagline: "What is your budget or financial proforma for the property?",
  },
  {
    id: "title-insurance",
    ...
    status: "upcoming",
    tagline: "What is your title insurance for the property?",
  },
];
